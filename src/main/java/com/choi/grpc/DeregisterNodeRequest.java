...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return grpcService.internal_static_com_choi_service_DeregisterNodeRequest_descriptor;
  }

  @Override
  protected FieldAccessorTable
      internalGetFieldAccessorTable() {
    return grpcService.internal_static_com_choi_service_DeregisterNodeRequest_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            DeregisterNodeRequest.class, Builder.class);
  }
  ...
  public boolean equals(final Object obj) {
    ...
    if (!(obj instanceof DeregisterNodeRequest)) {
      return super.equals(obj);
    }
    DeregisterNodeRequest other = (DeregisterNodeRequest) obj;
  ...
  public static DeregisterNodeRequest parseFrom(
  ...
  public static DeregisterNodeRequest parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static DeregisterNodeRequest parseFrom(
  ...
  public static DeregisterNodeRequest parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static DeregisterNodeRequest parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }

  public static DeregisterNodeRequest parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(DeregisterNodeRequest prototype) {
  ...
  public static final class Builder extends
    ...
    @Override
    public DeregisterNodeRequest getDefaultInstanceForType() {
      return DeregisterNodeRequest.getDefaultInstance();
    }

    @Override
    public DeregisterNodeRequest build() {
      DeregisterNodeRequest result = buildPartial();
    ...
    @Override
    public DeregisterNodeRequest buildPartial() {
      DeregisterNodeRequest result = new DeregisterNodeRequest(this);
      if (bitField0_ != 0) { buildPartial0(result); }
      onBuilt();
      return result;
    }

    private void buildPartial0(DeregisterNodeRequest result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof DeregisterNodeRequest) {
        return mergeFrom((DeregisterNodeRequest)other);
      } else {
    ...
    public Builder mergeFrom(DeregisterNodeRequest other) {
      if (other == DeregisterNodeRequest.getDefaultInstance()) return this;
  ...
  private static final DeregisterNodeRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new DeregisterNodeRequest();
  }

  public static DeregisterNodeRequest getDefaultInstance() {
